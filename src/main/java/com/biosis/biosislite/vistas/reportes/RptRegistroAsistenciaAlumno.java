 ...
 * @author RyuujiMD
 */
public class RptRegistroAsistenciaAlumno extends javax.swing.JInternalFrame {
    ...
    public RptRegistroAsistenciaAlumno() {
        initComponents();
        ...
        //Para seleccion con combo "Escoge rango"
        pnlMes.setVisible(false);
        pnlFecha.setVisible(false);
        pnlAnio.setVisible(false);
        
        //Para seleccion de combo "Escoge seleccion"
        pnlGrupoHorario.setVisible(false);
        pnlOficina.setVisible(false);
        pnlEmpleados.setVisible(false);
        
        radPorFecha.setVisible(false);
        radMes.setVisible(false);
        radAnio.setVisible(false);
        radTodos.setVisible(false);
        radGrupo.setVisible(false);
        radOficina.setVisible(false);
        radPersonalizado.setVisible(false);
...
//        FormularioUtil.modeloSpinnerFechaHora(spFechaFin, "dd/MM/yyyy");
    ...
    private void initComponents() {
        ...
        cboRangos = new javax.swing.JComboBox();
        pnlOpcionesRangos = new javax.swing.JPanel();
        ...
        pnlAnio = new javax.swing.JPanel();
        cboPeriodo = new javax.swing.JComboBox();
        pnl = new javax.swing.JPanel();
        cboSeleccion = new javax.swing.JComboBox();
        pnlOpcionesSeleccion = new javax.swing.JPanel();
        pnlGrupoHorario = new javax.swing.JPanel();
        cboGrupoHorario = new javax.swing.JComboBox();
        pnlOficina = new javax.swing.JPanel();
        ...
        pnlParametros.setLayout(new java.awt.GridLayout(1, 2));

        pnlRango.setBorder(javax.swing.BorderFactory.createTitledBorder("Rango"));
        pnlRango.setLayout(new java.awt.GridBagLayout());

        cboRangos.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Escoja Rango", "Por fecha", "Por mes", "Por año" }));
        cboRangos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboRangosActionPerformed(evt);
            }
        });
        ...
        pnlRango.add(cboRangos, gridBagConstraints);

        pnlFecha.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        dcFechaInicio.setFont(new java.awt.Font("SansSerif", 0, 11)); // NOI18N
        pnlFecha.add(dcFechaInicio);

        dcFechaFin.setFont(new java.awt.Font("SansSerif", 0, 11)); // NOI18N
        pnlFecha.add(dcFechaFin);

        pnlOpcionesRangos.add(pnlFecha);

        pnlMes.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));
        pnlMes.add(cboMes);
        ...
        pnlMes.add(cboPeriodo1);

        pnlOpcionesRangos.add(pnlMes);

        pnlAnio.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));
        ...
        pnlAnio.add(cboPeriodo);

        pnlOpcionesRangos.add(pnlAnio);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        pnlRango.add(pnlOpcionesRangos, gridBagConstraints);

        pnlParametros.add(pnlRango);

        pnl.setBorder(javax.swing.BorderFactory.createTitledBorder("Selección de empleados"));
        pnl.setLayout(new java.awt.GridBagLayout());

        cboSeleccion.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Escoge seleccion", "Todos", "Por grupo horario", "Por oficina", "Personalizado" }));
        ...
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        pnl.add(cboSeleccion, gridBagConstraints);

        pnlGrupoHorario.setLayout(new java.awt.GridBagLayout());
        ...
        pnlGrupoHorario.add(cboGrupoHorario, gridBagConstraints);

        pnlOpcionesSeleccion.add(pnlGrupoHorario);

        java.awt.GridBagLayout pnlOficinaLayout = new java.awt.GridBagLayout();
        pnlOficinaLayout.columnWidths = new int[] {0, 10, 0, 10, 0};
        pnlOficinaLayout.rowHeights = new int[] {0};
        pnlOficina.setLayout(pnlOficinaLayout);

        txtOficina.setEditable(false);
        txtOficina.setFont(new java.awt.Font("SansSerif", 0, 11)); // NOI18N
        txtOficina.setToolTipText("");
        txtOficina.setMinimumSize(new java.awt.Dimension(50, 21));
        txtOficina.setPreferredSize(new java.awt.Dimension(150, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 0.1;
        pnlOficina.add(txtOficina, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 0;
        pnlOficina.add(btnOficina, gridBagConstraints);

        pnlOpcionesSeleccion.add(pnlOficina);

        pnlEmpleados.setLayout(new java.awt.GridBagLayout());

        tblTabla.setFont(new java.awt.Font("SansSerif", 0, 11)); // NOI18N
        tblTabla.setRowHeight(8);
        tblTabla.setVisibleRowCount(8);
        ...
        pnlOpcionesSeleccion.add(pnlEmpleados);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        pnl.add(pnlOpcionesSeleccion, gridBagConstraints);

        pnlParametros.add(pnl);
        ...
        getContentPane().add(pnlParametros, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        getContentPane().add(radPorFecha, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        getContentPane().add(radMes, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        getContentPane().add(radAnio, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        getContentPane().add(radTodos, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        getContentPane().add(radGrupo, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        getContentPane().add(radOficina, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        getContentPane().add(radPersonalizado, gridBagConstraints);
...
//        }
    ...
    private void cboRangosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboRangosActionPerformed
        // TODO add your handling code here:
        switch(cboRangos.getSelectedItem().toString()){
    ...
    }//GEN-LAST:event_cboRangosActionPerformed

    private void cboSeleccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboSeleccionActionPerformed
        // TODO add your handling code here:
        switch(cboSeleccion.getSelectedItem().toString()){
            case "Todos":
                pnlGrupoHorario.setVisible(false);
                pnlOficina.setVisible(false);
                pnlEmpleados.setVisible(false);
                break;
            case "Por grupo horario":
                pnlGrupoHorario.setVisible(true);
                pnlOficina.setVisible(false);
                pnlEmpleados.setVisible(false);
                break;
            case "Por oficina":
                pnlGrupoHorario.setVisible(false);
                pnlOficina.setVisible(true);
                pnlEmpleados.setVisible(false);
                break;
            case "Personalizado":
                pnlGrupoHorario.setVisible(false);
    ...
    private javax.swing.JComboBox cboRangos;
    ...
    private javax.swing.JPanel pnlAnio;
    private javax.swing.JPanel pnlBotones;
    private javax.swing.JPanel pnlCerrarTab;
    private javax.swing.JPanel pnlEmpleados;
    private javax.swing.JPanel pnlFecha;
    private javax.swing.JPanel pnlGrupoHorario;
    private javax.swing.JPanel pnlMes;
    private javax.swing.JPanel pnlOficina;
    private javax.swing.JPanel pnlOpciones;
    private javax.swing.JPanel pnlOpcionesRangos;
    private javax.swing.JPanel pnlOpcionesSeleccion;
