 ...
 * @author RyuujiMD
 */
public class DlgInventarioSeleccion extends JDialog {

    /**
     * Creates new form DlgAmbienteBusqueda
     */
    private InventarioAmbienteControlador ic; 
    private InventarioAmbiente ambiente;
    private InventarioControlador inventarioC;
    private Inventario inventario;
    private Inventario inventarioExcluido;

    public DlgInventarioSeleccion(Component componente) {
        super(JOptionPane.getFrameForComponent(componente), true);
        this.ic = new InventarioAmbienteControlador();
        this.inventarioC = new InventarioControlador();
//        this.inventario = inventario;
    ...
    public DlgInventarioSeleccion(Component componente, Inventario inventario) {
        super(JOptionPane.getFrameForComponent(componente), true);
        this.ic = new InventarioAmbienteControlador();
        this.inventarioC = new InventarioControlador();
        this.inventarioExcluido = inventario;
//        this.inventario = inventario;
        initComponents();
        this.setLocationRelativeTo(componente);
        listar();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        lista.clear();
        lista.addAll(this.inventarioC.buscarTodos());
    ...
    private void txtBusquedaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBusquedaKeyReleased
        // TODO add your handling code here:
        lista.clear();
        lista.addAll(inventarioC.buscarXNombre(txtBusqueda.getText().toUpperCase()));
...
//    }
    ...
    private void listar() {
        for(Inventario filtro : this.inventarioC.buscarTodos()){
            if(filtro != this.inventarioExcluido){
                lista.add(filtro);
            }
        }
...
//        BeanProperty bCodigo = BeanProperty.create("Id");
