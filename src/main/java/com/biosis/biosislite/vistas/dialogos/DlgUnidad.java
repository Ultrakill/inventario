...
import com.biosis.biosislite.controladores.NacionalidadControlador;
import com.biosis.biosislite.controladores.PuestoControlador;
import com.biosis.biosislite.controladores.UnidadNegocioControlador;
 ...
 * @author Documentos
 */
public class DlgUnidad extends javax.swing.JDialog {

    /**
     * Creates new form DlgOficina
     * @param padre
     */
    private UnidadNegocio seleccion;
    
    public DlgUnidad(JInternalFrame padre) {
        super(JOptionPane.getFrameForComponent(padre), true);
        initComponents();
        listado = ObservableCollections.observableList(new ArrayList<UnidadNegocio>());
        bindeoSalvaje();
        buscar();
        this.setLocationRelativeTo(padre);
    }
    public DlgUnidad(JDialog padre) {
        super(padre, true);
        initComponents();
        listado = ObservableCollections.observableList(new ArrayList<UnidadNegocio>());
        bindeoSalvaje();
    ...
    private final List<UnidadNegocio> listado;
    private final UnidadNegocioControlador gc = new UnidadNegocioControlador();
    
    private void buscar() {
        String patron = txtOficina.getText();
        listado.clear();
        listado.addAll(gc.buscarXDescripcion(patron));
        tblTabla.packAll();
    }
    ...
    private void bindeoSalvaje() {
        ...
        tablaOficinaBind.addColumnBinding(pNombre).setColumnClass(String.class).setColumnName("Gerencia").setEditable(false);
        
        bindeo.addBinding(tablaOficinaBind);
        bindeo.bind();
    }
    
    public UnidadNegocio getGerencia(){
//        System.out.println("CARGO: "+seleccion.getNombre());
