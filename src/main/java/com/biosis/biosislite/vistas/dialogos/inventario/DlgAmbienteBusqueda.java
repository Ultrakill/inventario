...
public class DlgAmbienteBusqueda extends JDialog {
    ...
    public DlgAmbienteBusqueda(Component componente, Inventario inventario) {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        lista.clear();
        lista.addAll(this.ic.buscarXNombrexInventario(txtBusqueda.getText().toUpperCase(), this.inventario));
    ...
    private void txtBusquedaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBusquedaKeyReleased
        // TODO add your handling code here:
        lista.clear();
        lista.addAll(ic.buscarXNombreXCodigo(txtBusqueda.getText().toUpperCase()));
...
//    }
    ...
    private List<InventarioAmbiente> lista;
    ...
    private void listar() {
        lista = this.ic.buscarXInventario(inventario);
        ...
        BeanProperty bCodigo = BeanProperty.create("ambiente.codigo");
        BeanProperty bNombre = BeanProperty.create("ambiente.nombre");
...
//        binding.addColumnBinding(bResponsable).setColumnName("RESPONSABLE").setEditable(false);
    ...
    public InventarioAmbiente getAmbiente(){
