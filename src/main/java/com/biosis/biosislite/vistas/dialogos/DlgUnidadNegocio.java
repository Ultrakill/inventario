 ...
 * @author RyuujiMD
 */
public class DlgUnidadNegocio extends javax.swing.JDialog {
    ...
    public DlgUnidadNegocio(JInternalFrame padre) {
    ...
    public DlgUnidadNegocio(JDialog padre) {
        super(padre, true);
        initComponents();
        listado = ObservableCollections.observableList(new ArrayList<UnidadNegocio>());
        bindeoSalvaje();
    ...
    private final UnidadNegocioControlador unc = new UnidadNegocioControlador();
    
    private void buscar() {
        String patron = txtOficina.getText();
        listado.clear();
        listado.addAll(unc.buscarXDescripcion(patron));
        tblTabla.packAll();
    }
    ...
    private void bindeoSalvaje() {
        ...
        tablaOficinaBind.addColumnBinding(pNombre).setColumnClass(String.class).setColumnName("Cargo").setEditable(false);
