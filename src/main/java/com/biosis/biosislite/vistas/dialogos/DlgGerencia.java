 ...
 * @author Documentos
 */
public class DlgGerencia extends javax.swing.JDialog {

    /**
     * Creates new form DlgOficina
     * @param padre
     */
    private Gerencia seleccion;
    
    public DlgGerencia(JInternalFrame padre) {
        super(JOptionPane.getFrameForComponent(padre), true);
        initComponents();
        listado = ObservableCollections.observableList(new ArrayList<Gerencia>());
        bindeoSalvaje();
        buscar();
        this.setLocationRelativeTo(padre);
    }
    public DlgGerencia(JDialog padre) {
        super(padre, true);
        initComponents();
        listado = ObservableCollections.observableList(new ArrayList<Gerencia>());
        bindeoSalvaje();
    ...
    private final List<Gerencia> listado;
