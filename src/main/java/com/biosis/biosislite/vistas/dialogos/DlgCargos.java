...
public class DlgCargos extends javax.swing.JDialog {
     ...
     * @param padre
     */
    private Puesto seleccion;
    
    public DlgCargos(JInternalFrame padre) {
        super(JOptionPane.getFrameForComponent(padre), true);
        initComponents();
        listado = ObservableCollections.observableList(new ArrayList<Puesto>());
        bindeoSalvaje();
        buscar();
        this.setLocationRelativeTo(padre);
    }
    public DlgCargos(JDialog padre) {
        super(padre, true);
        initComponents();
        listado = ObservableCollections.observableList(new ArrayList<Puesto>());
        bindeoSalvaje();
    ...
    private final List<Puesto> listado;
    private final PuestoControlador pc = PuestoControlador.getInstance();
    
    private void buscar() {
        String patron = txtOficina.getText();
        listado.clear();
        listado.addAll(pc.buscarXDescripcion(patron));
        tblTabla.packAll();
    }
