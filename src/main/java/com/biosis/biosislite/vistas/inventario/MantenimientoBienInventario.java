 ...
 * @author Documentos
 */
public class MantenimientoBienInventario extends javax.swing.JInternalFrame {

    /**
     * Creates new form MantenimientoInventario
     */
    private static MantenimientoBienInventario instancia;

    public MantenimientoBienInventario() {
        initComponents();
        cargarComboPeriodo();
        listar();
    }

    public static MantenimientoBienInventario getInstancia() {
        if (instancia == null) {
            instancia = new MantenimientoBienInventario();
        }
        return instancia;
    }
    ...
    private List<Bien_Inventario> listar(Date inicio, Date fin, int pagina, int tamanio) {
